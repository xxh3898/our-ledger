...
- Transaction은 INCOME/EXPENSE NORMAL만 허용하고 active ASSET Account에 PRIMARY Entry 하나를 원자적으로 저장한다.
...
- TRANSFER, REFUND, CREDIT_CARD/LIABILITY posting은 Slice 2의 범위 밖이다.
